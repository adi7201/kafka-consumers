...
log_filename = os.path.join(log_directory, f"{todays_date}_insert_outbound.log")
...
class Outbound():
    ...
    def truck_cycle(self):
        try:
            ...
            self.cursor.execute("SELECT DISTINCT dock_no FROM truck_cycle WHERE dock_assign_time IS NOT NULL AND update_to_dynomodb=False AND dock_assign_time > CURRENT_DATE AND bound_type='outbound'")
                ...
                for truck in trucks:
                    ...
                    if truck['dock_in'] is None:
                        ...
                        if dock_in_result:
                            ...
                            print("---- DynamoDB INSERT DEBUG ----")
                            print("Truck No:", truck['truck_no'])
                            print("Postgres Dock In:", dock_in_time)
                            print("Used Timestamp (Key):", truck['timestamp'])
                            print("Used Type:", "dock_in")
                            print("-------------------------------")
